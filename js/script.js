...
function criarItemLista(contato) {
  ...
  item.setAttribute("class", "flex-1 min-w-[300px] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-4")
